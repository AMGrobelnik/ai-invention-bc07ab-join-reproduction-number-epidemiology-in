...
# dependencies = ["loguru"]
# ///
"""Transform RelBench rel-f1 data_out.json into exp_sel_data_out.json schema.

Creates a single unified dataset 'rel-f1' containing all table rows,
...
def main():
    ...
    output = {
        "metadata": {
            "source": "RelBench rel-f1 (Formula 1) relational database",
            "paper": "arXiv:2407.20060",
            "license": "CC-BY-4.0",
            "relbench_version": "2.1.1",
            "val_timestamp": metadata_item["val_timestamp"] if metadata_item else "2005-01-01",
            "test_timestamp": metadata_item["test_timestamp"] if metadata_item else "2010-01-01",
